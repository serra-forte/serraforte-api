...
-- AlterEnum
BEGIN;
CREATE TYPE "Status_new" AS ENUM ('REPROVED', 'APPROVED', 'PENDING', 'CANCELED', 'ANALYSIS', 'ANALYSE_REPROVED', 'CREATED', 'DONE', 'SENT', 'PROCESSED', 'REFUNDED', 'CHANGED', 'EXPIRED', 'AWAITING_LABEL_PAYMENT_PROCESS', 'AWAITING_LABEL_GENERATE', 'LABEL_GENERATED');
